...
function draw() {
  ...
  textSize(20);
  fill(255);
  text("Distancia: "+ distancia,650,30);
  ...
  text("Aperte a tecla direcional para a direita para reiniciar o jogo!",130,190);
...
function ciclistaRosa(){
        jogador1 =createSprite(900,Math.round(random(50, 250)));
        jogador1.scale =0.06;
...
function ciclistaAmarelo(){
        jogador2 =createSprite(900,Math.round(random(50, 250)));
        jogador2.scale =0.06;
...
function ciclistaVermelho(){
        jogador3 =createSprite(900,Math.round(random(50, 250)));
        jogador3.scale =0.06;
